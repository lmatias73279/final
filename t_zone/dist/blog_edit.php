...
if($_SESSION['permiso_blog'] !== 1 && $_SESSION['numdoc'] !== "1014273279" && $_SESSION['numdoc'] !== "1000693019"){
    header("location: login");
}
?>
<!DOCTYPE html>
...
<body>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Mis Blogs</h2>
            <button class="btn btn-primary" data-toggle="modal" data-target="#createUserModal">Crear Blog</button>
            <br></br>
            <div class="row">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        $sql = "SELECT * FROM blog  WHERE propietary = '$propietary' LIMIT $offset, $registrosPorPagina";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td style="text-align: center;">' . $row['date_edit'] . '</td>';
                            echo '<td style="text-align: center;"><img alt="image" src="assets/docs/blog/'.$row['img'].'" class="rounded-circle" width="35" height="35" style="object-fit: cover;" data-toggle="tooltip" title="" data-original-title="'.$row['resume'].'"></img></td>';
  ...
  $(document).ready(function() {
      ...
      if (encryptedStatus) {
          ...
          if (status === 'success_create') {
              ...
              toastr.success('El blog se creó correctamente.');
              ...
              toastr.success('El blog se actualizó correctamente.');
      ...
      $('.btn-edit').on('click', function() {
          ...
          $.ajax({
              ...
              success: function(response) {
                  ...
                  $('#modal-descripcion').val(data.p);
                  $('#modal-estado').val(data.status);
                  $('#modal-resume').val(data.resume);
                  $('#modal-log_cambios').val(data.log_changes);
              }
          });
      });
      ...
      $('#edit-form').on('submit', function(event) {
          ...
          $('#confirm-title').text($('#modal-title').val());
          $('#confirm-resume').text($('#modal-resume').val());
      ...
      $('#create-form').on('submit', function(event) {
          ...
          $('#confirm-create-title').text($('#create-title').val());
          $('#confirm-create-resume').text($('#create-resume').val());
      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Editar Blog</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">×</span>
                  </button>
              </div>
              <form id="edit-form" action="update_blog" method="POST" enctype="multipart/form-data">
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="modal-title">Titulo</label>
                    ...
                    <div class="form-group">
                        <label for="modal-resume">Resumen</label><span style="color: red;"> (máximo 200 caracteres)</span>
                        <input type="text" id="modal-resume" name="resume" class="form-control" maxlength="200" required>
                    </div>
                    ...
                    <div class="form-group mb-0">
                        <label for="modal-descripcion">Contenido</label>
      ...
      <div class="modal-dialog" role="document" style="max-height: 75vh; overflow-y: auto;">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <ul>
                      <li><strong>Titulo:</strong> <span id="confirm-title"></span></li>
                      <li><strong>Resumen:</strong> <span id="confirm-resume"></span></li>
                      <li><strong>Contenido:</strong> <span id="confirm-descripcion"></span></li>
                  </ul>
              </div>
              <div class="modal-footer">
  ...
  <div class="modal fade" id="createUserModal" tabindex="-1" role="dialog" aria-labelledby="createUserLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="createUserLabel">Crear Blog</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">×</span>
                  </button>
              </div>
              <form id="create-form" action="create_blog.php" method="POST" enctype="multipart/form-data">
                  <div class="modal-body">
                    <input type="hidden" id="modal-id" name="id">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="create-title" name="title" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="create-img">Imagen de portada</label>
                        <input type="file" id="create-img" name="img" class="form-control" accept=".jpg, .jpeg, .png, .gif" required>
                    </div>

                    <div class="form-group">
                        <label for="create-resume">Resumen </label><span style="color: red;"> (máximo 200 caracteres)</span>
                        <input type="text" id="create-resume" name="resume" class="form-control" maxlength="200" required>
                    </div>
                    
                    <div class="form-group mb-0">
                        <label for="create-descripcion">Contenido</label>
      ...
      <div class="modal-dialog" role="document" style="max-height: 75vh; overflow-y: auto;">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <ul>
                      <li><strong>Titulo:</strong> <span id="confirm-create-title"></span></li>
                      <li><strong>Resumen:</strong> <span id="confirm-create-resume"></span></li>
                      <li><strong>Contenido:</strong> <span id="confirm-create-descripcion"></span></li>
