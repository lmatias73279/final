...
$email = 'direccioncomercial@saludmentalsanamente.com.co'; // the email used to register google app
...
$mail->CharSet = 'UTF-8';
$mail->isHTML(true);
$mail->Subject = 'Agendamiento de cita - Sana Mente';
$mail->Body = '
...
<body style="margin: 0; padding: 0; background-color: #f9f9f9; color: #000000;">
  ...
  <div style="text-align: center; padding: 40px 20px; background-color: #2cbcd4;">
    ...
    <h1 style="color: #ffffff; font-size: 24px; margin: 0;">Tu cita está agendada! 📅💖</h1>
  </div>

  <!-- Contenido principal -->
  <div style="text-align: center; padding: 30px 20px; background-color: #ffffff;">
    <p style="font-size: 16px; color: #666666;">🌟 Tu sesión ha sido agendada con éxito. Aquí están todos los detalles para que no te pierdas nada:</p>
...
if (!$mail->send()) {
  ...
  $encryptedStatus = simpleEncrypt('success_insert', '2020');
