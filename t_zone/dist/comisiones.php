...
if($_SESSION['permiso'] !== 3 && $_SESSION['permiso'] !== 99){
    header("location: login");
}
?>
<!DOCTYPE html>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        $sqlCount = "SELECT COUNT(*) AS total FROM sessions WHERE psi = $filtro";
                        ...
                        $sql = "SELECT * FROM sessions WHERE psi = $filtro AND estado IN (6,7,8) LIMIT $offset, $registrosPorPagina";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $pacsql = $row['userID'];
                            $sqlpac = "SELECT numdoc, pn_usu, pa_usu FROM usuarios WHERE id = $pacsql";
                            ...
                            switch ($row['estado']) {
                                case 6:
                                    $texto = "En validación";
                                    $colorFondo = "#abc41c"; // Rojo claro
                                    break;
                                case 7:
                                    $texto = "Pendiente de pago";
                                    $colorFondo = "#5bc0de"; // Verde
                                    break;
                                case 8:
                                    $texto = "Pagada";
                                    $colorFondo = "#1cc433"; // Rojo
                                    break;
                                default:
